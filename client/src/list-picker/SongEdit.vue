    ...
    <v-card>
        <v-container fluid>
            <v-row justify="space-between" no-gutters>
                ...
                <v-col cols="auto">
                    <dialog-close-btn id="add-song-to-list-cancel" @click="$emit('cancel-edit')"></dialog-close-btn>
                </v-col>
            </v-row>
            ...
            <v-row justify="center">
                <v-col cols="auto">
                    <icon-btn color="success" icon="mdi-check" id="add-song-to-list-confirm"
                              @click="$emit('confirm-edit')">Confirm
                    </icon-btn>
                </v-col>
            </v-row>
        </v-container>
